      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-custom-field" class="form-horizontal">
		  ...
		  <div class="form-group" id="display-mask">
            ...
            <div class="col-sm-10">
              <input type="text" name="mask" id="input-mask" value="<?php echo $mask; ?>" class="form-control"/>
            </div>
          </div>
          <div class="form-group">
		  ...
		  <div class="form-group" id="display-shipping">
            ...
            <div class="col-sm-10">
              ...
              <div class="checkbox">
                <label>
                  <?php $shipping_code2 = $shipping_code.'.'.$shipping_code; if (in_array($shipping_code2, $custom_field_shipping_code)) { ?>
                  <input type="checkbox" name="custom_field_shipping_code[<?php echo $customer_group_row; ?>][shipping_code]" value="<?php echo $shipping_code.'.'.$shipping_code ?>" checked="checked" />
                  <?php echo $shipping_name; ?>
                  <?php } else { ?>
                  <input type="checkbox" name="custom_field_shipping_code[<?php echo $customer_group_row; ?>][shipping_code]" value="<?php echo $shipping_code.'.'.$shipping_code ?>" />
                  <?php echo $shipping_name; ?>
                  <?php } ?>
                </label>
              </div>
