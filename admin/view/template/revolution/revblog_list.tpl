          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'bd.title') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php if ($sort == 'b.sort_order') { ?>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($blog['revblog_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $blog['revblog_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $blog['revblog_id']; ?>" />
                    <?php } ?></td>
