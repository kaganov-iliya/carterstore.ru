        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-manufacturer">
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                <?php if ($textblockss) { ?>
                <?php foreach ($textblockss as $tab) { ?>
                <tr>
                  <td class="text-center"><?php if (in_array($tab['tb_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $tab['tb_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $tab['tb_id']; ?>" />
                    <?php } ?></td>
...
$('#button-filter').on('click', function() {
	var url = 'index.php?route=revolution/revtextblocks&token=<?php echo $token; ?>';
...
$('input[name=\'filter_name\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=revolution/revtextblocks/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
