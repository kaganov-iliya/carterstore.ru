...
class ControllerRevolutionRevcheckoutcustomfield extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('revolution/revcheckoutcustomfield', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('revolution/revtheme', 'token=' . $this->session->data['token'], true)
		);

		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('heading_title'),
			'href' => $this->url->link('revolution/revcheckoutcustomfield', 'token=' . $this->session->data['token'] . $url, true)
		);

		$data['add'] = $this->url->link('revolution/revcheckoutcustomfield/add', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('revolution/revcheckoutcustomfield/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) {
			...
			$data['custom_fields'][] = array(
				...
				'edit'            => $this->url->link('revolution/revcheckoutcustomfield/edit', 'token=' . $this->session->data['token'] . '&custom_field_id=' . $result['custom_field_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('revolution/revcheckoutcustomfield', 'token=' . $this->session->data['token'] . '&sort=cfd.name' . $url, true);
		$data['sort_location'] = $this->url->link('revolution/revcheckoutcustomfield', 'token=' . $this->session->data['token'] . '&sort=cf.location' . $url, true);
		$data['sort_type'] = $this->url->link('revolution/revcheckoutcustomfield', 'token=' . $this->session->data['token'] . '&sort=cf.type' . $url, true);
		$data['sort_status'] = $this->url->link('revolution/revcheckoutcustomfield', 'token=' . $this->session->data['token'] . '&sort=cf.status' . $url, true);
		$data['sort_sort_order'] = $this->url->link('revolution/revcheckoutcustomfield', 'token=' . $this->session->data['token'] . '&sort=cf.sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('revolution/revcheckoutcustomfield', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['custom_field_id'])) {
			$data['action'] = $this->url->link('revolution/revcheckoutcustomfield/add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('revolution/revcheckoutcustomfield/edit', 'token=' . $this->session->data['token'] . '&custom_field_id=' . $this->request->get['custom_field_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('revolution/revcheckoutcustomfield', 'token=' . $this->session->data['token'] . $url, true);
