										...
										<div id="input-option<?php echo $option['product_option_id']; ?>">
											<?php foreach ($option['product_option_value'] as $option_value) { ?>
												<div class="radio<?php if ($option['opt_image']) { ?> opt_with_img<?php } ?>">
													...
													<label <?php if ($option['opt_image']) { ?>data-toggle="tooltip" title="<?php echo $option_value['name']; ?>"<?php } ?> class="btn btn-default <?php if ($option_value['image']) { ?>label-in-img<?php } ?>" for="slider<?php echo $revp_id; ?>_<?php echo $option['product_option_id']; ?>_<?php echo $option_value['product_option_value_id']; ?>">
	  ...
	  success: function(json) {
		<?php if ($recalc_price) { ?>
			...
			<?php if ($description_options['zamena_description'] && $description_options['weight']) { ?>
				...
				<?php } else { ?>
					$('#slider<?php echo $revp_id; ?> .pr_weight_'+product_id).html(weight_format(weight, product_id));
				<?php } ?>
			<?php } ?>
			...
			<?php if ($stikers_status) { ?>
				...
				<?php } else { ?>
					$('#slider<?php echo $revp_id; ?> .special_no_format'+product_id).html(price_format(price));
				<?php } ?>
			<?php } ?>
			...
			<?php } else { ?>
				$('#slider<?php echo $revp_id; ?> .price_no_format'+product_id).html(price_format(special));
			<?php } ?>
		<?php } ?>
	  }
	});
...
function update_prices_product_slider<?php echo $revp_id; ?>(product_id, minimumvalue) {
	...
	$.ajax({
	  ...
	  success: function(json) {
		...
		<?php } else { ?>
			$('#slider<?php echo $revp_id; ?> .pr_quantity_'+product_id).html(number_format(end_quantity, product_id));
		<?php } ?>
...
max_height_div('#slider<?php echo $revp_id; ?> .product-thumb .product_buttons');
