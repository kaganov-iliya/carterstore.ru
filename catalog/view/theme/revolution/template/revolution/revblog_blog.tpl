...
<li><h1 class="inbreadcrumb" itemprop="headline"><?php echo $heading_title; ?></h1></li>
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="row">
      <div class="col-md-12">
        <?php if ($image && $main_image_status) { ?><img style="float: left; margin: 0 15px 15px 0;" src="<?php echo $image; ?>" alt="<?php echo $heading_title; ?>" /><?php } ?>
        <div>
        <div itemprop="description"><?php echo $description; ?></div>
		<p class="blog_time_bl" style="margin-top: 10px; text-align: left;"><i class="fa fa-clock-o" style="padding-right:3px;"></i><?php echo $data_added; ?></p>
        </div> 
        <?php if ($share_status) { ?>
...
<?php if ($products) { ?>
	  ...
	  <div class="heading_h"><h3><?php echo $heading_products_title; ?></h3></div>
      <div class="row">
