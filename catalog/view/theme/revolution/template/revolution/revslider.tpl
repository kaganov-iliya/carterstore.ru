...
<div class="rev_slider">
	<div class="heading_h"><h3><?php echo $heading_title; ?></h3><?php echo $url_all; ?></div>
    <div class="row product-layout">
        <div id="slider<?php echo $slider_id; ?>" class="owl-carousel">
				...
				<div class="caption product-info clearfix">
					...
					<div class="description_options">
						...
						<?php if ($revtheme_product_all['options_buy'] && $product['options'] && $product['options_buy']) { ?>
							<div class="well well-sm product-info options_buy">
								<div id="option_<?php echo $product['product_id']; ?>" class="options">
									<div class="form-group">
										...
										<?php } ?>
										<select class="form-control" onchange="get_product_option_id_slider<?php echo $slider_id; ?>('<?php echo $product['product_id']; ?>')" name="" id="slider<?php echo $slider_id; ?>_soption_<?php echo $product['product_id']; ?>">
							...
							$('#slider<?php echo $slider_id; ?> select.form-control option:nth-child(1)').attr('selected', 'selected');
							$( document ).ready(function() {
								get_product_option_id_slider<?php echo $slider_id; ?> (<?php echo $product['product_id']; ?>);
							});
							function get_product_option_id_slider<?php echo $slider_id; ?> (product_id) {
								var sel_option_id = document.getElementById('slider<?php echo $slider_id; ?>_soption_'+product_id);
								var option_id = sel_option_id.options[sel_option_id.selectedIndex].getAttribute('product_option_id');
								sel_option_id.setAttribute('name', 'option['+option_id+']');
								update_prices_product_slider<?php echo $slider_id; ?> (product_id,1);
							}
							--></script>
								...
								<?php foreach ($product['options'] as $option) { ?>
									<?php if ($option['type'] == 'select') { ?>
										<div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
											<label class="control-label" for="slider<?php echo $slider_id; ?>_input-option<?php echo $option['product_option_id']; ?>"><?php echo $option['name']; ?>:</label>
											<select onchange="update_prices_product_slider<?php echo $slider_id; ?>(<?php echo $product['product_id']; ?>,<?php echo $product['minimum']; ?>);" name="option[<?php echo $option['product_option_id']; ?>]" id="slider<?php echo $slider_id; ?>_input-option<?php echo $option['product_option_id']; ?>" class="form-control">
											...
											<div id="input-option<?php echo $option['product_option_id']; ?>">
												<?php foreach ($option['product_option_value'] as $option_value) { ?>
													<div class="radio<?php if ($option['opt_image']) { ?> opt_with_img<?php } ?>">
														<input onchange="update_prices_product_slider<?php echo $slider_id; ?>(<?php echo $product['product_id']; ?>,<?php echo $product['minimum']; ?>);" type="radio" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" id="slider<?php echo $slider_id; ?>_<?php echo $option['product_option_id']; ?>_<?php echo $option_value['product_option_value_id']; ?>" />
														<label <?php if ($option['opt_image']) { ?>data-toggle="tooltip" title="<?php echo $option_value['name']; ?>"<?php } ?> class="btn btn-default <?php if ($option_value['image']) { ?>label-in-img<?php } ?>" for="slider<?php echo $slider_id; ?>_<?php echo $option['product_option_id']; ?>_<?php echo $option_value['product_option_value_id']; ?>">
											...
											<div id="input-option<?php echo $option['product_option_id']; ?>">
												<?php foreach ($option['product_option_value'] as $option_value) { ?>
													<div class="radio checkbox<?php if ($option['opt_image']) { ?> opt_with_img<?php } ?>">
														<input onchange="update_prices_product_slider<?php echo $slider_id; ?>(<?php echo $product['product_id']; ?>,<?php echo $product['minimum']; ?>);" type="checkbox" name="option[<?php echo $option['product_option_id']; ?>][]" value="<?php echo $option_value['product_option_value_id']; ?>" id="slider<?php echo $slider_id; ?>_<?php echo $option['product_option_id']; ?>_<?php echo $option_value['product_option_value_id']; ?>" />
														<label <?php if ($option['opt_image']) { ?>data-toggle="tooltip" title="<?php echo $option_value['name']; ?>"<?php } ?> class="btn btn-default <?php if ($option_value['image']) { ?>label-in-img<?php } ?>" for="slider<?php echo $slider_id; ?>_<?php echo $option['product_option_id']; ?>_<?php echo $option_value['product_option_value_id']; ?>">
															<?php if ($option_value['image']) { ?>
																<img src="<?php echo $option_value['image']; ?>" alt="<?php echo $option_value['name'] . ($option_value['price'] ? ' ' . $option_value['price_prefix'] . $option_value['price'] : ''); ?>" class="img-thumbnail" /> <?php if (!$option['opt_image']) { ?><?php echo $option_value['name']; ?><?php } ?>
															<?php } else { ?>
									...
									<?php if ($option['type'] == 'text') { ?>
										<div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
										  <label class="control-label" for="slider<?php echo $slider_id; ?>_input-option<?php echo $option['product_option_id']; ?>"><?php echo $option['name']; ?>:</label>
										  <input type="text" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option['value']; ?>" placeholder="<?php echo $option['name']; ?>" id="slider<?php echo $slider_id; ?>_input-option<?php echo $option['product_option_id']; ?>" class="form-control" />
										</div>
									<?php } ?>
									<?php if ($option['type'] == 'textarea') { ?>
										<div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
										  <label class="control-label" for="slider<?php echo $slider_id; ?>_input-option<?php echo $option['product_option_id']; ?>"><?php echo $option['name']; ?>:</label>
										  <textarea name="option[<?php echo $option['product_option_id']; ?>]" rows="5" placeholder="<?php echo $option['name']; ?>" id="slider<?php echo $slider_id; ?>_input-option<?php echo $option['product_option_id']; ?>" class="form-control"><?php echo $option['value']; ?></textarea>
										</div>
									<?php } ?>
									...
									<?php if ($option['type'] == 'date') { ?>
										<div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
										  ...
										  <div class="input-group date">
											<input type="text" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option['value']; ?>" data-date-format="YYYY-MM-DD" id="slider<?php echo $slider_id; ?>_input-option<?php echo $option['product_option_id']; ?>" class="form-control" />
									...
									<?php if ($option['type'] == 'datetime') { ?>
										<div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
										  ...
										  <div class="input-group datetime">
											<input type="text" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option['value']; ?>" data-date-format="YYYY-MM-DD HH:mm" id="slider<?php echo $slider_id; ?>_input-option<?php echo $option['product_option_id']; ?>" class="form-control" />
											<span class="input-group-btn">
									...
									<?php if ($option['type'] == 'time') { ?>
										<div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
										  ...
										  <div class="input-group time">
											<input type="text" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option['value']; ?>" data-date-format="HH:mm" id="slider<?php echo $slider_id; ?>_input-option<?php echo $option['product_option_id']; ?>" class="form-control" />
											<span class="input-group-btn">
											<button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
											</span></div>
										</div>
								...
								<?php if ($ch_quantity && ($product['price_number'] > 0 || $zakaz_price_null) && ($product['quantity'] > 0 || $zakaz)) { ?>
									<div class="number">
										<div class="frame-change-count">
											<div class="btn-plus">
												<button type="button" onclick="validate_pole_slider<?php echo $slider_id; ?>(this,<?php echo $product['product_id']; ?>,'+',<?php echo $product['minimum']; ?>,<?php echo $product['quantity']; ?>);">+</button>
											</div>
											<div class="btn-minus">
												<button type="button" onclick="validate_pole_slider<?php echo $slider_id; ?>(this,<?php echo $product['product_id']; ?>,'-',<?php echo $product['minimum']; ?>,<?php echo $product['quantity']; ?>);">-</button>
											</div>
										</div>
										<input type="text" name="quantity" class="plus-minus" value='<?php echo $product['minimum']; ?>' onchange="validate_pole_slider<?php echo $slider_id; ?>(this);" onkeyup="validate_pole_slider<?php echo $slider_id; ?>(this,<?php echo $product['product_id']; ?>,'=',<?php echo $product['minimum']; ?>,<?php echo $product['quantity']; ?>);">
									</div>
								<?php } else { ?>
...
<script type="text/javascript"><!--
<?php if ($slider) { ?>
	$('#slider<?php echo $slider_id; ?> .item').attr('class', 'product-layout col-lg-12 item');
	$("#slider<?php echo $slider_id; ?>").owlCarousel({
	responsiveBaseWidth: '#slider<?php echo $slider_id; ?>',
	<?php if ($chislo_ryad) { ?>
...
<?php } else { ?>
	$('#slider<?php echo $slider_id; ?>').css('display', 'block').css('padding-top', '2px');
	$('#slider<?php echo $slider_id; ?> .item').attr('class', 'product-layout col-lg-3 col-md-3 col-sm-4 col-xs-12 item');
<?php } ?>

<?php if ($img_slider) { ?>
	$('#slider<?php echo $slider_id; ?> .owlproduct').owlCarousel({
		items: 1,
		singleItem: true,
		mouseDrag: false,
		touchDrag: false,
...
<?php foreach ($products as $product) { if ($product['minimum'] > 1 && $recalc_price) { ?>
	update_quantity_slider<?php echo $slider_id; ?>(<?php echo $product['product_id']; ?>, <?php echo $product['minimum']; ?>);
<?php } } ?>
function get_revpopup_cart_quantity_slider<?php echo $slider_id; ?>(product_id) {
	input_val = $('#slider<?php echo $slider_id; ?> .product_'+product_id+' .plus-minus').val();
	quantity  = parseInt(input_val);
	return quantity;
}
function validate_pole_slider<?php echo $slider_id; ?>(val, product_id, znak, minimumvalue, maximumvalue) {
	val.value = val.value.replace(/[^\d,]/g, '');
	if (val.value == '') val.value = minimumvalue;
	maximumvalue = Number($('#slider<?php echo $slider_id; ?> .pr_quantity_'+product_id).text());
	if (maximumvalue < 1) maximumvalue = 9999;
	input_val = $('#slider<?php echo $slider_id; ?> .product_'+product_id+' .plus-minus');	
	...
	<?php } ?>
	update_quantity_slider<?php echo $slider_id; ?>(product_id, input_val.val());
}
function update_quantity_slider<?php echo $slider_id; ?>(product_id, quantity) {
	<?php if ($recalc_price) { ?>
		quantity = quantity;
	<?php } else { ?>
		quantity = 1;
	...
	data = $('#slider<?php echo $slider_id; ?> .product_'+product_id+' .options input[type=\'text\'], #slider<?php echo $slider_id; ?> .product_'+product_id+' .options input[type=\'hidden\'], #slider<?php echo $slider_id; ?> .product_'+product_id+' .options input[type=\'radio\']:checked, #slider<?php echo $slider_id; ?> .product_'+product_id+' .options input[type=\'checkbox\']:checked, #slider<?php echo $slider_id; ?> .product_'+product_id+' .options select');
	$.ajax({
		...
		<?php if ($recalc_price) { ?>
			...
			<?php if ($description_options['zamena_description'] && $description_options['weight']) { ?>
				...
				<?php if ($revtheme_product_all['recalc_price_animate']) { ?>
					var start_weight = parseFloat($('#slider<?php echo $slider_id; ?> .pr_weight_'+product_id).attr('data-weight'));
					$({val:start_weight}).animate({val:weight}, {
						duration: 500,
						easing: 'swing',
						step: function(val) {
							$('#slider<?php echo $slider_id; ?> .pr_weight_'+product_id).html(weight_format(val, product_id));
						}
					});
					$('#slider<?php echo $slider_id; ?> .pr_weight_'+product_id).attr('data-weight', json['weight']);
				<?php } else { ?>
					$('#slider<?php echo $slider_id; ?> .pr_weight_'+product_id).html(weight_format(weight, product_id));
				<?php } ?>
			<?php } ?>
			...
			<?php if ($stikers_status) { ?>
				...
				<?php if ($revtheme_product_all['recalc_price_animate']) { ?>
					var start_price = parseFloat($('#slider<?php echo $slider_id; ?> .special_no_format'+product_id).html().replace(/\s*/g,''));
					$({val:start_price}).animate({val:price}, {
						duration: 500,
						easing: 'swing',
						step: function(val) {
							$('#slider<?php echo $slider_id; ?> .special_no_format'+product_id).html(price_format(val));
						}
					});
				<?php } else { ?>
					$('#slider<?php echo $slider_id; ?> .special_no_format'+product_id).html(price_format(price));
				<?php } ?>
			<?php } ?>
			
			var special = json['special_n'];
			<?php if ($revtheme_product_all['recalc_price_animate']) { ?>
				var start_special = parseFloat($('#slider<?php echo $slider_id; ?> .price_no_format'+product_id).html().replace(/\s*/g,''));
				$({val:start_special}).animate({val:special}, {
					duration: 500,
					easing: 'swing',
					step: function(val) {
						$('#slider<?php echo $slider_id; ?> .price_no_format'+product_id).html(price_format(val));
					}
				});
			<?php } else { ?>
				$('#slider<?php echo $slider_id; ?> .price_no_format'+product_id).html(price_format(special));
			<?php } ?>
		<?php } ?>
	  }
	});
}
function update_prices_product_slider<?php echo $slider_id; ?>(product_id, minimumvalue) {
	input_val = $('#slider<?php echo $slider_id; ?> .product_'+product_id+' .plus-minus').val();
	if (input_val > minimumvalue) {
		input_val = minimumvalue;
		$('#slider<?php echo $slider_id; ?> .product_'+product_id+' .plus-minus').val(minimumvalue);
	}
	<?php if ($recalc_price) { ?>
	quantity = parseInt(input_val);
	<?php } else { ?>
	...
	$.ajax({
	  ...
	  success: function(json) {
		...
		<?php if ($img_slider) { ?>
		$('#slider<?php echo $slider_id; ?> .product_'+product_id+' .image .owl-item:first-child img').attr('src', json['opt_image']);
		<?php } else { ?>
		$('#slider<?php echo $slider_id; ?> .product_'+product_id+' .image img').attr('src', json['opt_image']);
		<?php } ?>
		
		<?php if ($description_options['zamena_description'] && $description_options['model']) { ?>
		$('#slider<?php echo $slider_id; ?> .product_'+product_id+' .pr_model_'+product_id).html(json['opt_model']);
		<?php } ?>
	  
		var end_quantity = json['option_quantity'];
		<?php if ($revtheme_product_all['recalc_price_animate']) { ?>
			var start_quantity = parseFloat($('#slider<?php echo $slider_id; ?> .pr_quantity_'+product_id).html().replace(/\s*/g,''));
			$({val:start_quantity}).animate({val:end_quantity}, {
				duration: 500,
				easing: 'swing',
				step: function(val) {
					$('#slider<?php echo $slider_id; ?> .pr_quantity_'+product_id).html(number_format(val, product_id));
				}
			});
		<?php } else { ?>
			$('#slider<?php echo $slider_id; ?> .pr_quantity_'+product_id).html(number_format(end_quantity, product_id));
		<?php } ?>
...
max_height_div('#slider<?php echo $slider_id; ?> .product-thumb h4');
$('#slider<?php echo $slider_id; ?> .product-thumb .description_options').css('min-height', 'initial');
<?php if (!$setting_all_settings['cat_opis_opt'] || $slider) { ?>
max_height_div('#slider<?php echo $slider_id; ?> .product-thumb .description_options');
<?php } ?>
max_height_div('#slider<?php echo $slider_id; ?> .product-thumb .price');
max_height_div('#slider<?php echo $slider_id; ?> .product-thumb .number');
max_height_div('#slider<?php echo $slider_id; ?> .product-thumb .product_buttons');
