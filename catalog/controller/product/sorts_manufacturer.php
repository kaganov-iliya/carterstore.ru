...
if ($sort_price_ASC) {	
	$data['sorts'][] = array(
		...
		'value' => 'p.price-ASC',
		'href'  => $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $this->request->get['manufacturer_id'] . '&sort=ps.price&order=ASC' . $url)
	);
}
if ($sort_price_DESC) {	
	$data['sorts'][] = array(
		...
		'value' => 'p.price-DESC',
		'href'  => $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $this->request->get['manufacturer_id'] . '&sort=ps.price&order=DESC' . $url)
	);
}
if ($sort_rating_DESC) {
$data['sorts'][] = array(
