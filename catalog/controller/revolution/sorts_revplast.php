...
if ($sort_name_ASC) {	
	$data['sorts'][] = array(
		...
		'value' => 'p.name-ASC',
		'href'  => $this->url->link('revolution/revplast', '&sort=p.name&order=ASC' . $url)
	);
}
if ($sort_name_DESC) {	
	$data['sorts'][] = array(
		...
		'value' => 'p.name-DESC',
		'href'  => $this->url->link('revolution/revplast', '&sort=p.name&order=DESC' . $url)
	);
}
if ($sort_price_ASC) {	
	$data['sorts'][] = array(
...
if ($sort_date_added_ASC) {
	$data['sorts'][] = array(
		...
		'href'  => $this->url->link('revolution/revplast', '&sort=p.date_added&order=ASC' . $url)
	);
}
