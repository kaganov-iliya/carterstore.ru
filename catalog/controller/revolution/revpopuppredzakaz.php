<?php
class ControllerRevolutionRevpopuppredzakaz extends Controller {
	public function index() {
		...
		$settings = (array)$this->config->get('revtheme_predzakaz');
		$data['revtheme_predzakaz'] = $settings;
		...
		if ($product_info) {
			...
			$data['heading_title'] = $this->language->get('text_predzakaz');
			$data['button_shopping'] = $this->language->get('button_shopping');
			$data['button_checkout'] = $this->language->get('text_order_predzakaz');
			...
			if (VERSION >= 2.2) {
				$this->response->setOutput($this->load->view('revolution/revpopuppredzakaz', $data));
			} else {
				$this->response->setOutput($this->load->view('revolution/template/revolution/revpopuppredzakaz.tpl', $data));
			}
	...
	public function make_order() {
		...
		$settings = $this->config->get('revtheme_predzakaz');
