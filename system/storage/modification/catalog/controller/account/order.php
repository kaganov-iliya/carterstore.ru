...
class ControllerAccountOrder extends Controller {
	public function index() {
		...
		$this->document->setTitle($this->language->get('text_rev_text_order'));
		...
		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('text_rev_text_order'),
	...
	public function info() {
		...
		if ($order_info) {
			$this->document->setTitle($this->language->get('text_order').' '.$order_id);
...
'model' => (isset($option['model']) ? $option['model'] : false),
				...
				$data['products'][] = array(
					'name'     => $product['name'],
					'model'    => $product['model'], 'sku' => $product['sku'], 'image' => $image, 'href' => $this->url->link('product/product', 'product_id=' . $product['product_id']), 'sku' => $product['sku'],
					'option'   => $option_data,
