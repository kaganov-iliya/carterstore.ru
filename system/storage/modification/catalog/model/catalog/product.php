...
,'options_buy' => $query->row['options_buy'], 'short_description' => nl2br($query->row['short_description'])
			);
		} else {
			return false;
		}
			...
			if ($this->config->get('config_tax')) {
				if (!empty($data['filter_price_min'])) {
					if (!$data['filter_instock']) {
						$sql .= " HAVING ((CASE WHEN special IS NOT NULL THEN special + (CASE WHEN ftax IS NOT NULL THEN ftax ELSE 0 END) + (CASE WHEN ftax IS NOT NULL THEN special * (ptax / 100) ELSE 0 END) WHEN discount IS NOT NULL THEN discount + (CASE WHEN ftax IS NOT NULL THEN ftax ELSE 0 END) + (CASE WHEN ftax IS NOT NULL THEN discount * (ptax / 100) ELSE 0 END) ELSE p.price + (CASE WHEN ftax IS NOT NULL THEN ftax ELSE 0 END) + (CASE WHEN ftax IS NOT NULL THEN p.price * (ptax / 100) ELSE 0 END) END) >= '" . (int)$data['filter_price_min'] . "' OR (CASE WHEN special IS NOT NULL THEN special + (CASE WHEN ftax IS NOT NULL THEN ftax ELSE 0 END) + (CASE WHEN ftax IS NOT NULL THEN special * (ptax / 100) ELSE 0 END) WHEN discount IS NOT NULL THEN discount + (CASE WHEN ftax IS NOT NULL THEN ftax ELSE 0 END) + (CASE WHEN ftax IS NOT NULL THEN discount * (ptax / 100) ELSE 0 END) ELSE p.price + (CASE WHEN ftax IS NOT NULL THEN ftax ELSE 0 END) + (CASE WHEN ftax IS NOT NULL THEN p.price * (ptax / 100) ELSE 0 END) END) = 0)";
					} else {
						$sql .= " HAVING (CASE WHEN special IS NOT NULL THEN special + (CASE WHEN ftax IS NOT NULL THEN ftax ELSE 0 END) + (CASE WHEN ftax IS NOT NULL THEN special * (ptax / 100) ELSE 0 END) WHEN discount IS NOT NULL THEN discount + (CASE WHEN ftax IS NOT NULL THEN ftax ELSE 0 END) + (CASE WHEN ftax IS NOT NULL THEN discount * (ptax / 100) ELSE 0 END) ELSE p.price + (CASE WHEN ftax IS NOT NULL THEN ftax ELSE 0 END) + (CASE WHEN ftax IS NOT NULL THEN p.price * (ptax / 100) ELSE 0 END) END) >= '" . (int)$data['filter_price_min'] . "'";
					}
				}
				if (!empty($data['filter_price_max'])) {
					...
					$sql .= " (CASE WHEN special IS NOT NULL THEN special + (CASE WHEN ftax IS NOT NULL THEN ftax ELSE 0 END) + (CASE WHEN ftax IS NOT NULL THEN special * (ptax / 100) ELSE 0 END) WHEN discount IS NOT NULL THEN discount + (CASE WHEN ftax IS NOT NULL THEN ftax ELSE 0 END) + (CASE WHEN ftax IS NOT NULL THEN discount * (ptax / 100) ELSE 0 END) ELSE p.price + (CASE WHEN ftax IS NOT NULL THEN ftax ELSE 0 END) + (CASE WHEN ftax IS NOT NULL THEN p.price * (ptax / 100) ELSE 0 END) END) <= '" . (int)$data['filter_price_max'] . "'";
				}
			} else {
				if (!empty($data['filter_price_min'])) {
					if (!$data['filter_instock']) {
						$sql .= " HAVING ((CASE WHEN special IS NOT NULL THEN special WHEN discount IS NOT NULL THEN discount ELSE p.price END) >= '" . (int)$data['filter_price_min'] . "' OR (CASE WHEN special IS NOT NULL THEN special WHEN discount IS NOT NULL THEN discount ELSE p.price END) = 0)";
					} else {
						$sql .= " HAVING (CASE WHEN special IS NOT NULL THEN special WHEN discount IS NOT NULL THEN discount ELSE p.price END) >= '" . (int)$data['filter_price_min'] . "'";
					}
				}
				if (!empty($data['filter_price_max'])) {
					if (!empty($data['filter_price_min'])) {
					...
					$sql .= " (CASE WHEN special IS NOT NULL THEN special WHEN discount IS NOT NULL THEN discount ELSE p.price END) <= '" . (int)$data['filter_price_max'] . "'";
				}
			}
