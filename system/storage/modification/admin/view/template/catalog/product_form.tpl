...
<td class="text-left"><input type="text" name="product_image[<?php echo $image_row; ?>][video]" value="<?php echo $product_image['video']; ?>" class="form-control" /></td>
...
html += '<td class="text-left"><?php echo $entry_model; ?></td>'; html += '<td class="text-left"><?php echo $entry_foto; ?></td>'
